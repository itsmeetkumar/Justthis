...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Part III<br>Identification of Criminal</h1>
          </div>
          <div class="col-sm-6">
 ...
 <!-- /.middlename -->
          <div class="card card-primary">
              ...
              <div class="form-group">
                    <label for="primarylang">First name</label>
                    <input type="text" class="form-control" id="perp_first_name" placeholder="Enter Perpetrator first name" name="perp_first_name">
                  </div>
                  <div class="form-group">
                    <label for="secondarylang">Last name</label>
                  ...
                  <div class="form-group">
                    ...
                    <select id="country" name="country_of_origin" class="form-control">
  ...
  <div class="card card-primary">
               ...
               <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="redinglang">Linkedin URL</label>
                    <input type="text" class="form-control" id="linkedin_url" placeholder="Enter Perpetrator's Linkedin URL" name="linkedin_url">
                  </div>

                  <div class="form-group">
                    <label for="redinglang">Instagram ID</label>
                    <input type="text" class="form-control" id="IG_name" placeholder="Enter Perpetrator's Instagram ID" name="IG_name">
                  </div>

                  <div class="form-group">
                    <label for="redinglang">Email ID</label>
                    <input type="text" class="form-control" id="email" placeholder="Enter Perpetrator's Email ID" name="email">
                  </div>

                    <div class="form-group">
                    <label for="redinglang">Phone Number</label>
                    <input type="text" class="form-control" id="phone_number" placeholder="Enter Perpetrator's phone number" name="phone_number">
                  </div>
              ...
              <div class="card card-primary">
               ...
               <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="occupation" placeholder="Enter Perpetrator's occupation" name="occupation">
                  </div>

                  <div class="form-group">
                    <label for="redinglang">company name</label>
                    <input type="text" class="form-control" id="company_name" placeholder="Enter Perpetrator's company name" name="company_name">
                  </div>
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="redinglang">Upload Image Icon</label>
                    <input type="text" class="form-control" id="IG_name" placeholder="Enter Perpetrator's Instagram ID" name="IG_name">
                  </div>
