              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="experience" placeholder="Experience" name="experience">
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="document_url" placeholder="Document URL" name="document_url">
                  </div>               
                </div>
                <!-- /.card-body -->
