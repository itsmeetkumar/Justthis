          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Sahar Rohani</h3>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#varification" data-toggle="tab">Identification</a></li>
                </ul>
              </div><!-- /.card-header -->
              ...
              <div class="card-body">
                ...
                <div class="active tab-pane" id="basic">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="firstname" value="Sahar" placeholder="Enter First Name" name="firstname">
                  </div>
                  <div class="form-group">
                    <label for="lastname">Last Name</label>
                    <input type="text" class="form-control" id="lastname" value="Rohani" placeholder="Enter Last Name" name="lastname">
                  </div>
                  <div class="form-group">
...
<option value="Zimbabwe">Zimbabwe</option>
                  ...
                  <div class="tab-pane" id="varification">
                    <form class="form-horizontal">
                     <div class="card-body">
                  <div class="form-group">
