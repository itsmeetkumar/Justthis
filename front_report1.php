...
<div class="content-wrapper">
 ...
 <!-- /.middlename -->
 <form action="<?php echo $base_url; ?>/front_report1.php" metthod="post">
          <div class="card card-primary">
                <div class="card-body">
                  <div class="form-group">
                    <label for="manner_of_last_entry">Select Type of case</label>
                    <select class="form-control" name="gh" id="gh">
                          <option value="1">Assault</option>
                          <option value="1">Accident</option>
                          <option value="1">Bully</option>
                          <option value="2">Immigratikon</option>
...
if($_GET["gh"]==1){
  ?>
 <form action="<?php echo $base_url; ?>/front_criminal.php">
          <div class="card card-primary">
                <div class="card-body">
