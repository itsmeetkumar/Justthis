              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="propic" placeholder="Profile Pic URL" name="propic">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="recovemail" placeholder="Recovery Email" name="recovemail">
                  </div>
